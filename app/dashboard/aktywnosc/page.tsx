    ...
    <div style={{ padding: '0 0 80px' }}>
      <header style={{ padding: '32px 48px 20px', position: 'relative' }}>
        ...
        <h1 className="display" style={{ margin: 0, fontSize: 'clamp(40px, 5vw, 60px)' }}>
          Aktyw<em style={{ color: 'var(--c3)' }}>ność</em>.
        </h1>
      </header>
      ...
      <div style={{ padding: '0 48px' }}>
        <div style={{
          ...
          <FloatingDeco top={-20} right={60} rot={-10} delay={0.3}>
            <Bow size={90} color="var(--c3)" />
          </FloatingDeco>
          <FloatingDeco bottom={-10} left={40} rot={8} delay={0.8}>
            <Sparkle size={22} color="var(--c5)" />
          </FloatingDeco>

          <div style={{ fontSize: 64, marginBottom: 20 }}>◈</div>
          <h2 style={{ fontFamily: C, fontStyle: 'italic', fontSize: 38, color: 'var(--ink)', marginBottom: 12 }}>
            Aktywność — <em style={{ color: 'var(--c3)' }}>wkrótce</em>
          </h2>
          <p style={{ fontFamily: B, color: 'var(--ink-2)', fontSize: 15, maxWidth: 360, margin: '0 auto' }}>
            Tutaj zobaczysz kto zarezerwował Twoje życzenia i wszystkie powiadomienia z list.
          </p>
        </div>
      </div>
    </div>
